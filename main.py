...
CSV_FOLDER_DIR = './rank'
CSV_FILE_DIR = CSV_FOLDER_DIR + '/kms_rank.csv'

# 인풋: maple.gg 랭킹 페이지(1이상의 정수)
# 아웃풋: 해당하는 페이지(캐릭터 20개)의 table row를 list로 반환
...
# 아웃풋: 해당하는 캐릭터의 랭크, 서버, 닉네임, 레벨, 직업, 인기도를 dict로 반환
# 예시: [0][0]->오지환, [0][1]->루나, [1][0]-> 태주,
